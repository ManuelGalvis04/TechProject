...
def uploader():
    ...
    if file:
        ...
        # En lugar de usar la sesión, pasamos el nombre del archivo como variable
        return render_template('display_file.html', file_name=file_name, content=output_text)
