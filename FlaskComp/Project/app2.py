...
smtp_port = 587
email_usuario = ''  # Reemplaza con tu email
email_contraseña = ''  # Reemplaza con tu contraseña

# Crear el correo
destinatario = 'auxcalidadinterior@minexis.com'  # Reemplaza con el email del destinatario
asunto = 'COMPUESTAS SGS PRUEBA 1'
cuerpo = """"""
...
try:
    ...
    servidor.sendmail(email_usuario, destinatario, texto)
    servidor.quit()
